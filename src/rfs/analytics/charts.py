...
class ChartData:
    ...
    def add_dataset(self, label: str, data: List[Union[int, float]], 
                   color: Optional[str] = None, **options) -> 'ChartData':
        """데이터셋 추가"""
        dataset = {
            "label": label,
            "data": data,
...
class Chart(ABC):
    ...
    def __init__(self, chart_id: str, chart_type: ChartType, 
                 title: str = "", options: Optional[ChartOptions] = None):
...
class LineChart(Chart):
    ...
    def __init__(self, chart_id: str, title: str = "", options: Optional[ChartOptions] = None):
    ...
    def prepare_data(self, raw_data: List[Dict[str, Any]]) -> Result[ChartData, str]:
        ...
        try:
            ...
            for item in raw_data:
                ...
                series_data[series][x_val] = y_val
                labels.add(x_val)
...
class BarChart(Chart):
    ...
    def __init__(self, chart_id: str, title: str = "", horizontal: bool = False,
...
class PieChart(Chart):
    ...
    def __init__(self, chart_id: str, title: str = "", doughnut: bool = False,
                 options: Optional[ChartOptions] = None):
        ...
        try:
            ...
            for i, item in enumerate(raw_data):
                ...
                if label:
                    ...
                    colors.append(self.options.color_scheme[color_idx])
...
class HistogramChart(Chart):
    ...
    def __init__(self, chart_id: str, title: str = "", bins: int = 10,
                 options: Optional[ChartOptions] = None):
    ...
    def prepare_data(self, raw_data: List[Dict[str, Any]]) -> Result[ChartData, str]:
        ...
        try:
            ...
            for item in raw_data:
                ...
                heatmap_data.append({"x": x, "y": y, "v": value})
                x_labels.add(x)
                y_labels.add(y)
...
class ChartBuilder:
    ...
    def build(self) -> Chart:
        ...
        if self.chart_type in [ChartType.PIE, ChartType.DOUGHNUT]:
            return chart_class(self.chart_id, self.title, 
                             self.chart_type == ChartType.DOUGHNUT, self.options)
