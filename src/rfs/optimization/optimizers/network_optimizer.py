...
class ResponseCache:
    ...
    def _generate_key(self, url: str, headers=None) -> str:
        """캐시 키 생성"""
    ...
    def get(self, url: str, headers=None) -> Optional[Dict[str, Any]]:
        """캐시에서 응답 조회"""
...
class NetworkOptimizer:
    ...
    async def batch_requests(
        self, requests: List[Dict[str, Any]], max_concurrent=10
