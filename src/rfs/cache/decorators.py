...
from .base import get_cache, CacheBackend
...
class CacheKeyBuilder:
    ...
    def build_key(self, func: Callable, args: tuple, kwargs: dict, 
    ...
    def _hash_args(self, args: tuple, kwargs: dict) -> str:
        ...
        try:
            ...
            # JSON 직렬화 후 해시
            data = json.dumps([serializable_args, serializable_kwargs], 
    ...
    def decorator(func: Callable) -> Callable:
        ...
        if asyncio.iscoroutinefunction(func):
            ...
            async def async_wrapper(*args, **kwargs):
                ...
                # 캐시 키 생성
                cache_key = _generate_cache_key(key_builder, func, args, kwargs, key, version)
            ...
            async def async_wrapper(*args, **kwargs):
                ...
                if cache_backend:
                    if pattern:
                        ...
                        cache_key = _generate_cache_key(key_builder, func, args, kwargs, key)
