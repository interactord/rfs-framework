    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                if include_timing:
                    log_message += f" | Duration: {execution_time:.2f}ms"
                ...
                if include_errors:
                    ...
                    logger.error(
                        f"[{operation_id}] Operation failed: {operation_name} | "
                        f"Error ID: {error_id} | Error: {str(e)} | "
