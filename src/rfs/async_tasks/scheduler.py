...
class Schedule:
    ...
    def calculate_next_run(self) -> Optional[datetime]:
        ...
        match self.schedule_type:
            ...
            case ScheduleType.INTERVAL:            if self.interval:
                if self.last_run:
                return self.last_run + self.interval
                else:
                return now + self.interval
            case ScheduleType.ONCE:            if self.start_time and self.run_count == 0:
                return self.start_time
            case ScheduleType.DAILY:            if self.last_run:
                ...
                return next_run
            case ScheduleType.WEEKLY:            if self.last_run:
                ...
                return next_run
            case ScheduleType.MONTHLY:            if self.last_run:
