        ...
        def sync_wrapper(*args, **kwargs):
            ...
            while attempts <= retry:
                try:
                    ...
                    if no_rollback_on:
                        if any(isinstance(e, exc_type) for exc_type in no_rollback_on):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if isinstance(rollback_result, Failure):
                    raise TransactionError(f"Failed to rollback to savepoint: {rollback_result.error}")
                raise
